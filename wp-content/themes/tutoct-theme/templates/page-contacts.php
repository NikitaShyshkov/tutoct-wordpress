...
<main class="bg-[#F6EEFF] h-full w-full px-[150px] flex flex-col">
    ...
    <div id="block-2" class="w-full grid grid-cols-2 my-[60px] gap-[15px]">
        <div class="grid grid-cols-2 gap-5">
            ...
            <div class="p-5 col-span-2 bg-white rounded-2xl flex flex-col justify-start items-start gap-[15px]">
                ...
                <div class="flex justify-start items-center gap-2.5">
                    <div class="w-10 h-10 bg-white rounded-[40px] border border-[#d7d7d7]"></div>
                    <div class="w-6 h-6 relative overflow-hidden">
                        <div data-svg-wrapper class="absolute left-[7px] top-[3px]">
                    ...
                    <div class="w-10 h-10 bg-white rounded-[40px] border border-[#d7d7d7]"></div>
                    <div class="w-6 h-6 relative overflow-hidden">
                        <div data-svg-wrapper class="absolute left-[4px] top-[4px]">
                    ...
                    <div class="w-6 h-6 relative overflow-hidden">
                        ...
                        <div data-svg-wrapper class="absolute left-[9px] top-[7.50px]">
                    ...
                    <div class="w-10 h-10 bg-white rounded-[40px] border border-[#d7d7d7]"></div>
                    <div class="w-6 h-6 relative overflow-hidden">
                        <div data-svg-wrapper class="absolute left-[3px] top-[3px]">
        ...
        <div class="p-5 bg-white rounded-2xl flex flex-col justify-start items-start gap-1.5">
            ...
            <div class="w-[555px] justify-start text-[#120c38] text-[15px] font-normal font-['Mulish']">Ми тут, щоб допомогти вам! Якщо у вас є запитання або пропозиції, не соромтеся звертатися – ми завжди на зв’язку та готові надати підтримку</div>
            <div class="flex">
                <!-- Поле Имя -->
                <input type="text" placeholder="Ім'я" class="w-full h-12 px-4 bg-gray-50 border border-gray-200 rounded-lg text-gray-600 text-base font-normal focus:outline-none focus:ring-2 focus:ring-purple-300 placeholder-gray-500">

                <!-- Поле Призвище -->
                <input type="text" placeholder="Прізвище" class="w-full h-12 px-4 bg-gray-50 border border-gray-200 rounded-lg text-gray-600 text-base font-normal focus:outline-none focus:ring-2 focus:ring-purple-300 placeholder-gray-500">

                <!-- Поле Ваш Email -->
                <input type="email" placeholder="Ваш Email" class="w-full h-12 px-4 bg-gray-50 border border-gray-200 rounded-lg text-gray-600 text-base font-normal focus:outline-none focus:ring-2 focus:ring-purple-300 placeholder-gray-500">
            </div>

            <!-- Поле Повідомлення -->
            <div class="relative">
                <textarea placeholder="Повідомлення" class="w-full h-32 px-4 pt-4 pb-12 bg-gray-50 border border-gray-200 rounded-lg text-gray-600 text-base font-normal resize-none focus:outline-none focus:ring-2 focus:ring-purple-300 placeholder-gray-500"></textarea>
                <div class="absolute bottom-3 right-3">
                    <div data-svg-wrapper class="left-[3px] top-[4px] absolute">
                    ...
                    <div data-svg-wrapper class="left-[9.50px] top-[13px] absolute">
